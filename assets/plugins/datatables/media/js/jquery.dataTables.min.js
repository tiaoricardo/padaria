...
$.extend(true, $.fn.dataTable.defaults, {
    ...
    "dom": "<'row'<'col-md-6 col-sm-12'i><'col-md-6 col-sm-12'f>r>t<'row'<'col-md-4 col-sm-12'i><'col-md-4 col-sm-12'p><'col-md-4 col-sm-12'l>>", // datatable layout without  horizobtal scroll(used when bootstrap dropdowns used in the datatable cells)
    "language": {
	   "emptyTable":     "Não há registros a exibir!",
        "lengthMenu": "_MENU_ itens por página",
	   "search": "Buscar por: ",	
	   "zeroRecords": "Nenhum registro encontrado!",
        "paginate": {
            "previous": '<i class="fa fa-angle-left" title="Página anterior"></i>',
            "next": '<i class="fa fa-angle-right" title="Próxima página"></i>'
        },
	   "info": "Exibindo itens de _START_ a _END_ de um total de _TOTAL_ registros.",
	   "infoEmpty":      "",
	   "loadingRecords": "Aguarde! Carregando itens...",
	   "infoFiltered":   '<br /><i class="small">Pesquisados em um total de _MAX_ registros.</i>'
